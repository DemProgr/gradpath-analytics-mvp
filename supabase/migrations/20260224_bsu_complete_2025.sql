-- Полные данные БГУ 2025 - все специальности
-- Выполнить в Supabase SQL Editor

-- 1. Удаляем старые данные за 2025
DELETE FROM public.admission_stats WHERE specialty_id LIKE 'bsu-s%' AND year = 2025;

-- 2. Вставляем все данные за 2025
...
-- Военный факультет (bsu-15) - мужчины/женщины
('bsu-s75', 2025, NULL, NULL, 355, NULL, NULL),
('bsu-s75f', 2025, NULL, NULL, 377, NULL, NULL),
('bsu-s77', 2025, NULL, NULL, 338, NULL, NULL),
('bsu-s77f', 2025, NULL, NULL, 394, NULL, NULL),
('bsu-s78', 2025, NULL, NULL, 323, NULL, NULL),
('bsu-s78f', 2025, NULL, NULL, 394, NULL, NULL),
('bsu-s74', 2025, NULL, NULL, 335, NULL, NULL),
('bsu-s74f', 2025, NULL, NULL, 359, NULL, NULL),
...
-- 3. Добавляем новые специальности в таблицу specialties
...
('bsu-s111', 'bsu', 'Прикладная информатика', '6-05-0313-03', 'bsu-2', NULL),
...
-- Военный факультет (bsu-15) - для женщин
('bsu-s75f', 'bsu', 'Правоведение (юрисконсультская работа в военной сфере) (женщины)', '1-95 01 02', 'bsu-15', NULL),
('bsu-s77f', 'bsu', 'Международные отношения (международные отношения в информационной сфере) (женщины)', '1-95 01 05', 'bsu-15', NULL),
('bsu-s78f', 'bsu', 'Международные отношения (международные отношения в военной сфере) (женщины)', '1-95 01 04', 'bsu-15', NULL),
('bsu-s74f', 'bsu', 'Геоинформационные системы (геоинформационные системы специальные) (женщины)', '1-95 01 01', 'bsu-15', NULL)

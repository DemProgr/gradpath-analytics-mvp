...
-- ВФ (bsuir-7) - все специальности
-- Информационная безопасность (ГПК)
('bsuir-s28a', 2025, NULL, NULL, 330, NULL, NULL),
-- Информационная безопасность (МВД)
('bsuir-s28b', 2025, NULL, NULL, 294, NULL, NULL),
-- Информационная безопасность (ВС)
('bsuir-s28c', 2025, NULL, NULL, 333, NULL, NULL),
-- Компьютерная инженерия (ВС)
('bsuir-s26a', 2025, NULL, NULL, 342, NULL, NULL),
-- Компьютерная инженерия (ГПК)
('bsuir-s26b', 2025, NULL, NULL, 315, NULL, NULL),
-- Системы и сети инфокоммуникаций (ВС)
('bsuir-s27a', 2025, NULL, NULL, 302, NULL, NULL),
-- Системы и сети инфокоммуникаций (ВС) жен.
('bsuir-s27b', 2025, NULL, NULL, 345, NULL, NULL),
-- Системы и сети инфокоммуникаций (ГПК)
('bsuir-s27c', 2025, NULL, NULL, 310, NULL, NULL),
-- Системы и сети инфокоммуникаций (ССКП)
('bsuir-s27d', 2025, NULL, NULL, 292, NULL, NULL),
